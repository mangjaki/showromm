...
<div class="col-md-6 grid-margin stretch-card mt-3" >
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-description">Masukan Data Mobil</p>
        <form method="POST" action="{{ route('mobil.store')}}" class="forms-sample" enctype="multipart/form-data">
          @csrf
          <div class="form-group">
            <label for="merk">Merk Mobil</label>
            <input type="text" class="form-control" id="merk" name="merk" value="{{old('merk') ? old('merk'): $mobil['merk'] }}" placeholder="Masukan Merk Mobil">
            @error('merk')
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="tahun" name="tahun" value="{{ old('tahun') }}" placeholder="Masukan Tahun Mobil" required min="1900" max="{{ date('Y')}}">
            @error('tahun')
                <span class="text-danger">{{$message}}</span>
            @enderror
          </div>
